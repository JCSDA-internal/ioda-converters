...
# fname_in = ['2009335004815_19116_CS_2B-GEOPROF_GRANULE_P1_R05_E02_F00.hdf']
fname_in = ['2009212223327_17338_CS_2B-GEOPROF_GRANULE_P1_R05_E02_F00.hdf']
fname_out = "cpr_cloudsat_obs_2009335.nc4"

cpr_obs = read_cloudsat.read_cloudsat(fname_in)
cpr_obs["sequenceNumber"] = xr.DataArray(np.arange(cpr_obs.obs_id.size), cpr_obs.obs_id.coords)
