...
namespace Ingester
{
    ...
    {
     public:
        explicit Int64VecDataObject(const std::vector<int64_t>& int64Vector);
        ~Int64VecDataObject() = default;
        ...
        // Getters
        inline std::vector<int64_t> get() const { return int64Vector_; }

     private:
        /// \brief The data
        const std::vector<int64_t> int64Vector_;
