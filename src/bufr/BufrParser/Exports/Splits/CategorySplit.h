...
namespace Ingester
{
    ...
    {
     public:
        /// \brief Map of integers to strings where the key represents the split mnemonics integer value and the
        ///        value is a human readable name for the key.
        typedef  std::map<size_t, std::string> NameMap;

        /// \brief constructor
        /// \param mnemonic BUFR mnemonic to base the split on.
        /// \param map Map that defines the name of the created categories from the integer BUFR values.
