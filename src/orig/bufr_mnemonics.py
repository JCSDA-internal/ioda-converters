...
gpsro_mnemonics_dict = {
'MEFR': 'MEAN FREQUENCY',\
'IMPP': 'IMPACT PARAMETER',\
'BNDA': 'BENDING ANGLE',\
'FOST' :'FIRST ORDER STATISTICS',\
'HEIT' :'HEIGHT',\
'ARFR' :'ATMOSPHERIC REFRACTIVITY',\
'FOST' :'FIRST ORDER STATISTICS',\
'GPHTST' :'GEOPOTENTIAL HEIGHT',\
'PRES' :'PRESSURE',\
'TMDBST' :'TEMPERATURE/DRY BULB TEMPERATURE',\
'SPFH' :'SPECIFIC HUMIDITY',\
'PRES' :'PRESSURE',\
'PCCF' :'PER CENT CONFIDENCE'}
'''dictionary mapping gpsro mnemonics to human readable descriptions'''
satwnd_mnemonics_dict = {
'HAMD': 'HEIGHT ASSIGNMENT METHOD',\
'PRLC': 'PRESSURE',\
'WDIR': 'WIND DIRECTION',\
'WSPD': 'WIND SPEED',\
'Uwnd': 'Zonal Wind',\
...
'PCCF' :'PER CENT CONFIDENCE'}
'''dictionary mapping satwnd mnemonics to human readable descriptions'''
iasi_mnemonics_dict = {
'STCH': 'START CHANNEL',\
'ENCH': 'END CHANNEL',\
'CHSF': 'CHANNEL SCALE FACTOR',\
...
'SSDR': 'SCALED STANDARD DEVIATION OF AVHRR RADIANCE'}
'''dictionary mapping satwnd mnemonics to human readable descriptions'''
sevcsr_mnemonics_dict = {
'TMBRST':'BRIGHTNESS TEMPERATURE (KELVIN)'}
airsev_mnemonics_dict = {
'TMBR':'BRIGHTNESS TEMPERATURE (KELVIN)'}
esmhs_mnemonics_dict = {
'TMBRST':'BRIGHTNESS TEMPERATURE (KELVIN)'}
oneBmhs_mnemonics_dict = {
'TMBR':'BRIGHTNESS TEMPERATURE (KELVIN)'}
oneBhrs4_mnemonics_dict = {
'TMBR':'BRIGHTNESS TEMPERATURE (KELVIN)'}
eshrs3_mnemonics_dict = {
'TMBRST':'BRIGHTNESS TEMPERATURE (KELVIN)'}
goesfv_mnemonics_dict = {
'TMBR':'BRIGHTNESS TEMPERATURE (KELVIN)'}
ssmisu_mnemonics_dict = {
'TMBR':'BRIGHTNESS TEMPERATURE (KELVIN)'}
